...
*Therefore "convert_to_onnx" shell file uses v2.12.0 TensorFlow. The more detail about this script can be found in [Model Training part.](sections/model_training) )*
